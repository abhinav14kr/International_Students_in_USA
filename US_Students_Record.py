...
# Set x-axis ticks at 5-year intervals (adjust based on your dataset)
...
# Assuming your dataset is already loaded and named as 'record'.

# Create a line plot for the selected continents.
selected_continents = [
    'Asia', 'East_Asia', 'South_and_Central_Asia', 'Southeast_Asia'
]

# Define the years for custom x-axis labels.
custom_years = ['1949-50', '1974-75', '1999-00', '2004-05', '2009-10', '2014-15', '2019-20']

# Create a mapping from custom years to the closest available data points.
...
# Expand the vertical axis.
plt.ylim(bottom=0)

# Set custom x-axis ticks and add labels at the end of each line.
...
# Set a Seaborn style with a dark grey background
...
# Add values to the x-axis labels
